...
2. **In each terminal:**
   ...
   - Create a different account (different username)
   - Select option 2 to run the bot

Or duplicate the entire bot folder and run a separate bot from each copy!
